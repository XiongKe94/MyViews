package com.carl.views.roundview
...
/**
 * Created by Xiong Ke on 2017/9/18.
 *
...
class RoundFrameLayout : FrameLayout {
    ...
    private fun obtainAttributes(context: Context, attrs: AttributeSet?) {
        ...
        backgroundColor = ta.getColor(R.styleable.RoundFrameLayout_rv_backgroundColor, Color.TRANSPARENT)
        backgroundPressColor = ta.getColor(R.styleable.RoundFrameLayout_rv_backgroundPressColor, Integer.MAX_VALUE)
        cornerRadius = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_cornerRadius, 0)
        strokeWidth = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_strokeWidth, 0)
        strokeColor = ta.getColor(R.styleable.RoundFrameLayout_rv_strokeColor, Color.TRANSPARENT)
        strokePressColor = ta.getColor(R.styleable.RoundFrameLayout_rv_strokePressColor, Integer.MAX_VALUE)
        isRadiusHalfHeight = ta.getBoolean(R.styleable.RoundFrameLayout_rv_isRadiusHalfHeight, false)
        isWidthHeightEqual = ta.getBoolean(R.styleable.RoundFrameLayout_rv_isWidthHeightEqual, false)
        cornerRadiusTL = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_cornerRadius_TL, 0)
        cornerRadiusTR = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_cornerRadius_TR, 0)
        cornerRadiusBL = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_cornerRadius_BL, 0)
        cornerRadiusBR = ta.getDimensionPixelSize(R.styleable.RoundFrameLayout_rv_cornerRadius_BR, 0)
        isRippleEnable = ta.getBoolean(R.styleable.RoundFrameLayout_rv_isRippleEnable, false)
        ta.recycle()
    }
    ...
    fun setCornerRadius(cornerRadius: Int) {
        this.cornerRadius = Utils.dip2px(context, cornerRadius.toFloat())
        setBgSelector()
    }

    fun setStrokeWidth(strokeWidth: Int) {
        this.strokeWidth = Utils.dip2px(context, strokeWidth.toFloat())
        setBgSelector()
    }
